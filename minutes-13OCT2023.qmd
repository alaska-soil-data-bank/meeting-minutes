...
### Other business
Frances brought up an excellent questions - where can all opf these different file types live? Nic is working on it - Box will be the most likely place. I can link to Box from GitHub as well
Travis - another option could be to host a Teams workspace
Timm N. - Is there an api endpoint for GEMS? would be nice to have a database to database connection. Nic will talk to GEMS engineers.
